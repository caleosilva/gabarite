    ...
    <div className="p-8 space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 border-b pb-4">
          <Button onClick={() => controlador.aoClicarAdicionar()} variant={botoesPadrao.add.variant}>
          ...
          <Button 
            ...
            onClick={() => controlador.aoClicarEditar(state.itemUnicoSelecionado!)}
            variant="outline"
          >
            Editar
          </Button>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 bg-muted/30 p-4 rounded-lg border">
          <Select value={state.campoBuscaSelecionado} onValueChange={state.setCampoBuscaSelecionado}>
          ...
          <div className="flex flex-1 items-center gap-2">
            <Input 
              ...
              onKeyDown={(e) => e.key === 'Enter' && state.aplicarFiltroDeBusca()}
      ...
      <DataTable 
        ...
        totalDePaginas={Math.ceil(state.totalRegistros / state.paginacao.pageSize)}
